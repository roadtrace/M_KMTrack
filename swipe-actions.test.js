...
test('exports exclude deleted entries and restored entries return with unchanged schema and formatting', () => {
  ...
  assert.deepEqual(rows[0], ['Type of Defect','Timestamp','Latitude','Longitude','Latitude (DMM)','Longitude (DMM)','Expressway','Direction','Lane','Km Station','Photo','Photo Filename','Interchange / Exit','Interchange Segment']);
  assert.deepEqual(rows[1], ['Potholes','2026-09-01 09:00:00',14.1,120.2,'N14.1','E120.2','NLEX','NB','2',8200,'Yes','p.jpg','Dau Interchange','NB Entry Ramp']);
